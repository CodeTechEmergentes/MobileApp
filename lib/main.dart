...
import 'package:codetech_app/pages/Upcoming%20appointments.dart';
import 'package:codetech_app/pages/appointment_history.dart';
import 'package:codetech_app/pages/authentication/login.dart';
import 'package:codetech_app/pages/authentication/register.dart';
import 'package:codetech_app/pages/home_user.dart';
import 'package:codetech_app/pages/new_appointment.dart';
import 'package:codetech_app/pages/profile_user.dart';
import 'package:codetech_app/pages/review.dart';
import 'package:codetech_app/pages/schedule_appointment.dart';
import 'package:codetech_app/pages/technical_profile.dart';
